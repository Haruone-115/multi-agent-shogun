...
3. **Read `memory/MEMORY.md`** (shogun only) — persistent cross-session memory. If file missing, skip. _GitHub Copilot CLI users: this file is also auto-loaded via GitHub Copilot CLI's memory feature._
