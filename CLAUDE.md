...
3. **Read `memory/MEMORY.md`** (shogun only) — persistent cross-session memory. If file missing, skip. _Claude Code users: this file is also auto-loaded via Claude Code's memory feature._
