...
3. **Read `memory/MEMORY.md`** (shogun only) — persistent cross-session memory. If file missing, skip. _Codex CLI users: this file is also auto-loaded via Codex CLI's memory feature._
